...
enum Seconds: int
{
    ...
    /** @deprecated v1.1.2 and replaced with fromDays(int $days), will be removed in v2.0.0. */
    public static function days(int $days): int
    {
        return self::fromDays($days);
    }

    /** @deprecated v1.1.2 and replaced with fromHours(int $hours), will be removed in v2.0.0. */
    public static function hours(int $hours): int
    {
        return self::fromHours($hours);
    }

    /** @deprecated v1.1.2 and replaced with fromMinutes(int $minutes), will be removed in v2.0.0. */
    public static function minutes(int $minutes): int
    {
        return self::fromMinutes($minutes);
    }

    /** @deprecated v1.1.2 and replaced with fromWeeks(int $weeks), will be removed in v2.0.0. */
